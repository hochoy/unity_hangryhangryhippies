...
function LoadJSCode(e, t) {
    if (!Math.fround) {
        ...
        for (var n = {
            ...
            }, o = ["EMSCRIPTEN_START_ASM", "EMSCRIPTEN_START_FUNCS", "EMSCRIPTEN_END_FUNCS"], i = "var", a = "global.Math.fround;", r = 0, s = n.LOOKING_FOR_MODULE, d = 0, l = 0; s <= n.SCANNING_MODULE_FUNCTIONS && r < e.length; r++)
            if (47 == e[r] && 47 == e[r + 1] && 32 == e[r + 2] && String.fromCharCode.apply(null, e.subarray(r + 3, r + 3 + o[s].length)) === o[s]) s++;
            else if (s != n.SCANNING_MODULE_VARIABLES || l || 61 != e[r] || String.fromCharCode.apply(null, e.subarray(r + 1, r + 1 + a.length)) !== a) {
            if (l && 40 == e[r]) {
                for (var u = 0; l > u && e[r - 1 - u] == e[d - u];) u++;
                if (u == l) {
                    var c = e[r - 1 - u];
                    if (36 > c || c > 36 && 48 > c || c > 57 && 65 > c || c > 90 && 95 > c || c > 95 && 97 > c || c > 122)
                        for (; u; u--) e[r - u] = 32
                }
            }
        } else {
            for (d = r - 1; 32 != e[d - l];) l++;
            l && String.fromCharCode.apply(null, e.subarray(d - l - i.length, d - l)) === i || (d = l = 0)
        }
    }
    LoadJSCodeBlob(new Blob([e], {
...
function DecompressAndLoadFile(e, t, n) {
    ...
    o.open("GET", e, !0), o.onprogress = n, o.responseType = "arraybuffer", o.onload = function() {
        var n = new Uint8Array(o.response),
            i = (new Date).getTime(),
            a = pako.inflate(n),
            r = (new Date).getTime();
        console.log("Decompressed " + e + " in " + (r - i) + "ms. You can remove this delay if you configure your web server to host files using gzip compression."), t(a)
    }, o.onerror = function() {
        console.log("Could not download " + e), didShowErrorMessage || 0 != document.URL.indexOf("file:") || (alert("It seems your browser does not support running Unity WebGL content from file:// urls. Please upload it to an http server, or try a different browser."), didShowErrorMessage = !0)
    }, o.send(null)
}

function LoadCompressedFile(e, t, n) {
    if (CompressionState.current == CompressionState.Unsupported) return void DecompressAndLoadFile(e, t);
    ...
    var o = new XMLHttpRequest;
    o.open("GET", e, !0), o.responseType = "arraybuffer", o.onprogress = function(e) {
        n && n(e), CompressionState.current == CompressionState.Pending && (0 == o.status || 200 == o.status ? CompressionState.Set(CompressionState.Supported) : CompressionState.Set(CompressionState.Unsupported))
    }, o.onload = function() {
...
function LoadCompressedJS(e, t) {
    LoadCompressedFile(e, function(e) {
        LoadJSCode(e, t)
    })
}
...
function fetchRemotePackageWrapper(e, t, n, o) {
    LoadCompressedFile(e, n, function(n) {
        ...
        if (n.total && (i = n.total), n.loaded) {
            Module.dataFileDownloads || (Module.dataFileDownloads = {}), Module.dataFileDownloads[o] = {
                loaded: n.loaded,
                total: i
            };
            var a = 0,
            ...
            a = Math.ceil(a * Module.expectedDataFileDownloads / s), Module.setStatus && Module.setStatus("Downloading data... (" + r + "/" + a + ")")
...
var CompressionState = {
    ...
    Set: function(e) {
        if (CompressionState.current == CompressionState.Pending) {
            ...
            for (var t = 0; t < CompressionState.pendingServerRequests.length; t++) CompressionState.pendingServerRequests[t]()
        }
    }
};
...
LoadCompressedFile(Module.memUrl, function(e) {
        Module.memoryInitializerRequest.response = e, Module.memoryInitializerRequest.callback && Module.memoryInitializerRequest.callback()
    }),
    function(e) {
        ...
        return function e(t, n, o) {
            ...
            1: [function(e, t, n) {
                ...
                var i = {
                        ...
                        flattenChunks: function(e) {
                            ...
                            for (r = new Uint8Array(o), i = 0, t = 0, n = e.length; n > t; t++) a = e[t], r.set(a, i), i += a.length;
                            return r
                        }
                    },
                    a = {
            ...
            2: [function(e, t, n) {
                ...
                function o(e, t) {
                    if (65537 > t && (e.subarray && r || !e.subarray && a)) return String.fromCharCode.apply(null, i.shrinkBuf(e, t));
                ...
                for (var d = new i.Buf8(256), l = 0; 256 > l; l++) d[l] = l >= 252 ? 6 : l >= 248 ? 5 : l >= 240 ? 4 : l >= 224 ? 3 : l >= 192 ? 2 : 1;
                d[254] = d[254] = 1, n.string2buf = function(e) {
                    var t, n, o, a, r, s = e.length,
                        d = 0;
                    for (a = 0; s > a; a++) n = e.charCodeAt(a), 55296 === (64512 & n) && s > a + 1 && (o = e.charCodeAt(a + 1), 56320 === (64512 & o) && (n = 65536 + (n - 55296 << 10) + (o - 56320), a++)), d += 128 > n ? 1 : 2048 > n ? 2 : 65536 > n ? 3 : 4;
                    for (t = new i.Buf8(d), r = 0, a = 0; d > r; a++) n = e.charCodeAt(a), 55296 === (64512 & n) && s > a + 1 && (o = e.charCodeAt(a + 1), 56320 === (64512 & o) && (n = 65536 + (n - 55296 << 10) + (o - 56320), a++)), 128 > n ? t[r++] = n : 2048 > n ? (t[r++] = 192 | n >>> 6, t[r++] = 128 | 63 & n) : 65536 > n ? (t[r++] = 224 | n >>> 12, t[r++] = 128 | n >>> 6 & 63, t[r++] = 128 | 63 & n) : (t[r++] = 240 | n >>> 18, t[r++] = 128 | n >>> 12 & 63, t[r++] = 128 | n >>> 6 & 63, t[r++] = 128 | 63 & n);
                    return t
                }, n.buf2binstring = function(e) {
                    return o(e, e.length)
                }, n.binstring2buf = function(e) {
                    for (var t = new i.Buf8(e.length), n = 0, o = t.length; o > n; n++) t[n] = e.charCodeAt(n);
                    return t
                }, n.buf2string = function(e, t) {
                    var n, i, a, r, s = t || e.length,
                        l = new Array(2 * s);
                    for (i = 0, n = 0; s > n;)
                        if (a = e[n++], 128 > a) l[i++] = a;
                        else if (r = d[a], r > 4) l[i++] = 65533, n += r - 1;
                    else {
                        for (a &= 2 === r ? 31 : 3 === r ? 15 : 7; r > 1 && s > n;) a = a << 6 | 63 & e[n++], r--;
                        r > 1 ? l[i++] = 65533 : 65536 > a ? l[i++] = a : (a -= 65536, l[i++] = 55296 | a >> 10 & 1023, l[i++] = 56320 | 1023 & a)
                    }
                    return o(l, i)
            ...
            5: [function(e, t, n) {
                ...
                function o() {
                    for (var e, t = [], n = 0; 256 > n; n++) {
                        e = n;
                        for (var o = 0; 8 > o; o++) e = 1 & e ? 3988292384 ^ e >>> 1 : e >>> 1;
                        t[n] = e
                    }
                    return t
                }
            ...
            7: [function(e, t, n) {
                ...
                t.exports = function(e, t) {
                    var n, a, r, s, d, l, u, c, f, h, p, m, w, b, g, v, k, y, _, S, x, M, C, E, D;
                    n = e.state, a = e.next_in, E = e.input, r = a + (e.avail_in - 5), s = e.next_out, D = e.output, d = s - (t - e.avail_out), l = s + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, p = n.window, m = n.hold, w = n.bits, b = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, k = (1 << n.distbits) - 1;
                    e: do {
                        15 > w && (m += E[a++] << w, w += 8, m += E[a++] << w, w += 8), y = b[m & v];
                        t: for (;;) {
                            if (_ = y >>> 24, m >>>= _, w -= _, _ = y >>> 16 & 255, 0 === _) D[s++] = 65535 & y;
                            else {
                                if (!(16 & _)) {
                                    if (0 === (64 & _)) {
                                        y = b[(65535 & y) + (m & (1 << _) - 1)];
                                ...
                                S = 65535 & y, _ &= 15, _ && (_ > w && (m += E[a++] << w, w += 8), S += m & (1 << _) - 1, m >>>= _, w -= _), 15 > w && (m += E[a++] << w, w += 8, m += E[a++] << w, w += 8), y = g[m & k];
                                n: for (;;) {
                                    if (_ = y >>> 24, m >>>= _, w -= _, _ = y >>> 16 & 255, !(16 & _)) {
                                        if (0 === (64 & _)) {
                                            y = g[(65535 & y) + (m & (1 << _) - 1)];
                                            continue n
                                        }
                                    ...
                                    if (x = 65535 & y, _ &= 15, _ > w && (m += E[a++] << w, w += 8, _ > w && (m += E[a++] << w, w += 8)), x += m & (1 << _) - 1, x > u) {
                                    ...
                                    if (m >>>= _, w -= _, _ = s - d, x > _) {
                                        ...
                                        for (; S > 2;) D[s++] = C[M++], D[s++] = C[M++], D[s++] = C[M++], S -= 3;
                                        S && (D[s++] = C[M++], S > 1 && (D[s++] = C[M++]))
                                    } else {
                                        M = s - x;
                                        do D[s++] = D[M++], D[s++] = D[M++], D[s++] = D[M++], S -= 3; while (S > 2);
                    ...
                    S = w >> 3, a -= S, w -= S << 3, m &= (1 << w) - 1, e.next_in = a, e.next_out = s, e.avail_in = r > a ? 5 + (r - a) : 5 - (a - r), e.avail_out = l > s ? 257 + (l - s) : 257 - (s - l), n.hold = m, n.bits = w
                }
            }, {}],
            8: [function(e, t, n) {
                "use strict";
                ...
                function a(e) {
                    var t;
                    return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = U, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new b.Buf32(pe), t.distcode = t.distdyn = new b.Buf32(me), t.sane = 1, t.back = -1, D) : F
                }
                ...
                function s(e, t) {
                    var n, o;
                    return e && e.state ? (o = e.state, 0 > t ? (n = 0, t = -t) : (n = (t >> 4) + 1, 48 > t && (t &= 15)), t && (8 > t || t > 15) ? F : (null !== o.window && o.wbits !== t && (o.window = null), o.wrap = n, o.wbits = t, r(e))) : F
                }

                function d(e, t) {
                    var n, o;
                    return e ? (o = new i, e.state = o, o.window = null, n = s(e, t), n !== D && (e.state = null), n) : F
                }
                ...
                function u(e) {
                    if (ge) {
                        var t;
                        for (m = new b.Buf32(512), w = new b.Buf32(32), t = 0; 144 > t;) e.lens[t++] = 8;
                        for (; 256 > t;) e.lens[t++] = 9;
                        for (; 280 > t;) e.lens[t++] = 7;
                        for (; 288 > t;) e.lens[t++] = 8;
                        for (y(S, e.lens, 0, 288, m, 0, e.work, {
                                bits: 9
                            }), t = 0; 32 > t;) e.lens[t++] = 5;
                        y(x, e.lens, 0, 32, w, 0, e.work, {
                            bits: 5
                        }), ge = !1
                    }
                ...
                function c(e, t, n, o) {
                    var i, a = e.state;
                    return null === a.window && (a.wsize = 1 << a.wbits, a.wnext = 0, a.whave = 0, a.window = new b.Buf8(a.wsize)), o >= a.wsize ? (b.arraySet(a.window, t, n - a.wsize, a.wsize, 0), a.wnext = 0, a.whave = a.wsize) : (i = a.wsize - a.wnext, i > o && (i = o), b.arraySet(a.window, t, n - o, i, a.wnext), o -= i, o ? (b.arraySet(a.window, t, n - o, o, 0), a.wnext = o, a.whave = a.wsize) : (a.wnext += i, a.wnext === a.wsize && (a.wnext = 0), a.whave < a.wsize && (a.whave += i))), 0
                }

                function f(e, t) {
                    var n, i, a, r, s, d, l, f, h, p, m, w, pe, me, we, be, ge, ve, ke, ye, _e, Se, xe, Me, Ce = 0,
                        Ee = new b.Buf8(4),
                    ...
                    e: for (;;) switch (n.mode) {
                        case U:
                            ...
                            if (2 & n.wrap && 35615 === f) {
                                n.check = 0, Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, n.check = v(n.check, Ee, 2, 0), f = 0, h = 0, n.mode = N;
                                break
                            }
                        ...
                        case N:
                            ...
                            n.head && (n.head.text = f >> 8 & 1), 512 & n.flags && (Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, n.check = v(n.check, Ee, 2, 0)), f = 0, h = 0, n.mode = z;
                        case z:
                            for (; 32 > h;) {
                                if (0 === d) break e;
                                d--, f += i[r++] << h, h += 8
                            }
                            n.head && (n.head.time = f), 512 & n.flags && (Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, Ee[2] = f >>> 16 & 255, Ee[3] = f >>> 24 & 255, n.check = v(n.check, Ee, 4, 0)), f = 0, h = 0, n.mode = T;
                        case T:
                            for (; 16 > h;) {
                                if (0 === d) break e;
                                d--, f += i[r++] << h, h += 8
                            }
                            n.head && (n.head.xflags = 255 & f, n.head.os = f >> 8), 512 & n.flags && (Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, n.check = v(n.check, Ee, 2, 0)), f = 0, h = 0, n.mode = P;
                        case P:
                            if (1024 & n.flags) {
                                for (; 16 > h;) {
                                    if (0 === d) break e;
                                ...
                                n.length = f, n.head && (n.head.extra_len = f), 512 & n.flags && (Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, n.check = v(n.check, Ee, 2, 0)), f = 0, h = 0
                            } else n.head && (n.head.extra = null);
                            n.mode = Z;
                        case Z:
                            if (1024 & n.flags && (w = n.length, w > d && (w = d), w && (n.head && (_e = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), b.arraySet(n.head.extra, i, r, w, _e)), 512 & n.flags && (n.check = v(n.check, i, w, r)), d -= w, r += w, n.length -= w), n.length)) break e;
                            n.length = 0, n.mode = q;
                        case q:
                            if (2048 & n.flags) {
                                if (0 === d) break e;
                                w = 0;
                                do _e = i[r + w++], n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e)); while (_e && d > w);
                                if (512 & n.flags && (n.check = v(n.check, i, w, r)), d -= w, r += w, _e) break e
                        ...
                        case H:
                            if (4096 & n.flags) {
                                if (0 === d) break e;
                                w = 0;
                                do _e = i[r + w++], n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e)); while (_e && d > w);
                                if (512 & n.flags && (n.check = v(n.check, i, w, r)), d -= w, r += w, _e) break e
                        ...
                        case $:
                            ...
                            if (n.lencode = n.lendyn, n.lenbits = 7, xe = {
                                    bits: n.lenbits
                                }, Se = y(_, n.lens, 0, 19, n.lencode, 0, n.work, xe), n.lenbits = xe.bits, Se) {
                        ...
                        case ee:
                            for (; n.have < n.nlen + n.ndist;) {
                                for (; Ce = n.lencode[f & (1 << n.lenbits) - 1], we = Ce >>> 24, be = Ce >>> 16 & 255, ge = 65535 & Ce, !(h >= we);) {
                                    if (0 === d) break e;
                                    d--, f += i[r++] << h, h += 8
                                }
                                if (16 > ge) f >>>= we, h -= we, n.lens[n.have++] = ge;
                                else {
                                    if (16 === ge) {
                                        for (Me = we + 2; Me > h;) {
                                            if (0 === d) break e;
                                        ...
                                        _e = n.lens[n.have - 1], w = 3 + (3 & f), f >>>= 2, h -= 2
                                    } else if (17 === ge) {
                                        for (Me = we + 3; Me > h;) {
                                            if (0 === d) break e;
                                            d--, f += i[r++] << h, h += 8
                                        }
                                        f >>>= we, h -= we, _e = 0, w = 3 + (7 & f), f >>>= 3, h -= 3
                                    } else {
                                        for (Me = we + 7; Me > h;) {
                                            if (0 === d) break e;
                                            d--, f += i[r++] << h, h += 8
                                        }
                                        f >>>= we, h -= we, _e = 0, w = 11 + (127 & f), f >>>= 7, h -= 7
                                    }
                                    if (n.have + w > n.nlen + n.ndist) {
                                        e.msg = "invalid bit length repeat", n.mode = ce;
                                        break
                                    }
                                    for (; w--;) n.lens[n.have++] = _e
                                }
                            }
                            if (n.mode === ce) break;
                            if (0 === n.lens[256]) {
                            ...
                            if (n.lenbits = 9, xe = {
                                    bits: n.lenbits
                                }, Se = y(S, n.lens, 0, n.nlen, n.lencode, 0, n.work, xe), n.lenbits = xe.bits, Se) {
                                e.msg = "invalid literal/lengths set", n.mode = ce;
                                break
                            }
                            if (n.distbits = 6, n.distcode = n.distdyn, xe = {
                                    bits: n.distbits
                                }, Se = y(x, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, xe), n.distbits = xe.bits, Se) {
                        ...
                        case ne:
                            ...
                            if (be && 0 === (240 & be)) {
                                for (ve = we, ke = be, ye = ge; Ce = n.lencode[ye + ((f & (1 << ve + ke) - 1) >> ve)], we = Ce >>> 24, be = Ce >>> 16 & 255, ge = 65535 & Ce, !(h >= ve + we);) {
                                    if (0 === d) break e;
                                    d--, f += i[r++] << h, h += 8
                                }
                                f >>>= ve, h -= ve, n.back += ve
                            }
                            if (f >>>= we, h -= we, n.back += we, n.length = ge, 0 === be) {
                                n.mode = se;
                                break
                            }
                            if (32 & be) {
                        ...
                        case ie:
                            for (; Ce = n.distcode[f & (1 << n.distbits) - 1], we = Ce >>> 24, be = Ce >>> 16 & 255, ge = 65535 & Ce, !(h >= we);) {
                                if (0 === d) break e;
                                d--, f += i[r++] << h, h += 8
                            }
                            if (0 === (240 & be)) {
                                for (ve = we, ke = be, ye = ge; Ce = n.distcode[ye + ((f & (1 << ve + ke) - 1) >> ve)], we = Ce >>> 24, be = Ce >>> 16 & 255, ge = 65535 & Ce, !(h >= ve + we);) {
                                    if (0 === d) break e;
                                    d--, f += i[r++] << h, h += 8
                                }
                                f >>>= ve, h -= ve, n.back += ve
                        ...
                        case re:
                            ...
                            if (w = m - l, n.offset > w) {
                                ...
                                w > n.wnext ? (w -= n.wnext, pe = n.wsize - w) : pe = n.wnext - w, w > n.length && (w = n.length), me = n.window
                            } else me = a, pe = s - n.offset, w = n.length;
                            w > l && (w = l), l -= w, n.length -= w;
                            do a[s++] = me[pe++]; while (--w);
                        ...
                        case de:
                            if (n.wrap) {
                                ...
                                if (m -= l, e.total_out += m, n.total += m, m && (e.adler = n.check = n.flags ? v(n.check, a, m, s - m) : g(n.check, a, m, s - m)), m = l, (n.flags ? f : o(f)) !== n.check) {
                ...
                function p(e, t) {
                    var n;
                    return e && e.state ? (n = e.state, 0 === (2 & n.wrap) ? F : (n.head = t, t.done = !1, D)) : F
                }
                var m, w, b = e("../utils/common"),
                    g = e("./adler32"),
                    v = e("./crc32"),
                    k = e("./inffast"),
                    y = e("./inftrees"),
                    ...
                    be = we,
                    ge = !0;
                n.inflateReset = r, n.inflateReset2 = s, n.inflateResetKeep = a, n.inflateInit = l, n.inflateInit2 = d, n.inflate = f, n.inflateEnd = h, n.inflateGetHeader = p, n.inflateInfo = "pako inflate (from Nodeca project)"
            }, {
                "../utils/common": 1,
                "./adler32": 3,
                "./crc32": 5,
            ...
            9: [function(e, t, n) {
                ...
                t.exports = function(e, t, n, p, m, w, b, g) {
                    var v, k, y, _, S, x, M, C, E, D = g.bits,
                        R = 0,
                        I = 0,
                        F = 0,
                        L = 0,
                    ...
                    if (A > L && (A = L), 0 === L) return m[w++] = 20971520, m[w++] = 20971520, g.bits = 1, 0;
                    for (F = 1; L > F && 0 === Z[F]; F++);
                    ...
                    if (e === s ? (T = H = b, x = 19) : e === d ? (T = u, P -= 257, H = c, G -= 257, x = 256) : (T = f, H = h, x = -1), z = 0, I = 0, R = F, S = w, B = A, O = 0, y = -1, N = 1 << A, _ = N - 1, e === d && N > a || e === l && N > r) return 1;
                    for (var j = 0;;) {
                        j++, M = R - O, b[I] < x ? (C = 0, E = b[I]) : b[I] > x ? (C = H[G + b[I]], E = T[P + b[I]]) : (C = 96, E = 0), v = 1 << R - O, k = 1 << B, F = k;
                        do k -= v, m[S + (z >> O) + k] = M << 24 | C << 16 | E | 0; while (0 !== k);
                        for (v = 1 << R - 1; z & v;) v >>= 1;
                        if (0 !== v ? (z &= v - 1, z += v) : z = 0, I++, 0 === --Z[R]) {
                            if (R === L) break;
                            R = t[n + b[I]]
                        }
                        if (R > A && (z & _) !== y) {
                            for (0 === O && (O = A), S += F, B = R - O, U = 1 << B; L > B + O && (U -= Z[B + O], !(0 >= U));) B++, U <<= 1;
                            if (N += 1 << B, e === d && N > a || e === l && N > r) return 1;
                            y = z & _, m[y] = A << 24 | B << 16 | S - w | 0
                        }
                    }
                    return 0 !== z && (m[S + z] = R - O << 24 | 64 << 16 | 0), g.bits = A, 0
                }
            }, {
                "../utils/common": 1
            }],
            ...
            "/lib/inflate.js": [function(e, t, n) {
                ...
                h.prototype.push = function(e, t) {
                    ...
                    return n === d.Z_STREAM_END && (o = d.Z_FINISH), o === d.Z_FINISH ? (n = a.inflateEnd(this.strm), this.onEnd(n), this.ended = !0, n === d.Z_OK) : o === d.Z_SYNC_FLUSH ? (this.onEnd(d.Z_OK), c.avail_out = 0, !0) : !0
                }, h.prototype.onData = function(e) {
                    this.chunks.push(e)
                }, h.prototype.onEnd = function(e) {
                    e === d.Z_OK && ("string" === this.options.to ? this.result = this.chunks.join("") : this.result = r.flattenChunks(this.chunks)), this.chunks = [], this.err = e, this.msg = this.strm.msg
                }, n.Inflate = h, n.inflate = o, n.inflateRaw = i, n.ungzip = o
            }, {
                "./utils/common": 1,
                "./utils/strings": 2,
                "./zlib/constants": 4,
        ...
        var e = function(e) {
            ...
            function n() {
                ...
                Module.FS_createPath("/", "Il2CppData", !0, !0), Module.FS_createPath("/Il2CppData", "Metadata", !0, !0), Module.FS_createPath("/", "Resources", !0, !0), Module.FS_createPath("/", "Managed", !0, !0), Module.FS_createPath("/Managed", "mono", !0, !0), Module.FS_createPath("/Managed/mono", "2.0", !0, !0), t.prototype = {
                    ...
                    finish: function(e) {
                        var t = this;
                        Module.FS_createPreloadedFile(this.name, null, e, !0, !0, function() {
                ...
                }, new t(0, 381082, 0, 0).open("GET", "/data.unity3d"), new t(381082, 381255, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(381255, 388257, 0, 0).open("GET", "/preserved_derived_types.xml"), new t(388257, 2371225, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(2371225, 3246197, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(3246197, 3273822, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_HangryHangryHippies.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {
                    fromCache: !1
                }, d ? (n(d), d = null) : l = n
            }
            var o;
            if ("object" == typeof window) o = window.encodeURIComponent(window.location.pathname.toString().substring(0, window.location.pathname.toString().lastIndexOf("/")) + "/");
            else {
            ...
            var i = "HangryHangryHippies.data",
                a = "HangryHangryHippies.data";
            ...
            fetchRemotePackageWrapper(r, s, function(e) {
                l ? (l(e), l = null) : d = e
            }, t), Module.calledRun ? n() : (Module.preRun || (Module.preRun = []), Module.preRun.push(n))
        };
        e()
    }();
